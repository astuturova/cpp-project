...
void LoginView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (LoginView::*)(const QString & , const QString & );
            if (_t _q_method = &LoginView::loginClicked; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void LoginView::loginClicked(const QString & _t1, const QString & _t2)
{
