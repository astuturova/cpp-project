...
struct qt_meta_stringdata_CLASSDashboardViewENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSDashboardViewENDCLASS = QtMocHelpers::stringData(
    "DashboardView"
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSDashboardViewENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject DashboardView::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSDashboardViewENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSDashboardViewENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSDashboardViewENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *DashboardView::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSDashboardViewENDCLASS.stringdata0))
